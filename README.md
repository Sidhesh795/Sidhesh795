...
│  CLASS:  AI / AUTOMATION / SECURITY EXPLORER                 │
│  ENERGY: CURIOUS WITH A SLIGHT BUG-FIXING OBSESSION          │
└──────────────────────────────────────────────────────────────┘
```
...
class Sidhesh:
    ...
    outside_the_terminal = ["Gym 🏋️", "Long rides 🏍️", "Thinking about the next idea"]

    interests = [
        "AI that is actually useful",
        "Automation that saves people time",
        "Cloud systems that do not mysteriously break",
...
## 🚀 Projects Currently Escaping My Laptop

| Project | The idea | Status |
|---|---|---|
| 🔎 [Sales Research Agent](https://github.com/Sidhesh795/Sales-research-agent) | Exploring how AI can make sales research faster and more useful | `building` |
| 🛡️ [Cloud Sentinel](https://github.com/Sidhesh795/Cloud-sentinel) | Exploring cloud monitoring and security through a hands-on project | `building` |
| 💪 [Fitness Project](https://github.com/Sidhesh795/Fitness-project-2) | Turning a fitness idea into a working application | `building` |

## 🎯 Main Quest

```javascript
const mainQuest = {
  learn: ["AI agents", "LLMs", "backend systems", "cloud security"],
  build: ["useful tools", "cleaner projects", "things people can actually try"],
  defeat: ["tutorial hell", "unfinished ideas", "code that only works on my machine"],
  reward: "becoming the developer I currently look up to"
};
```
...
|---|---|---|
| AI-powered tools | Consistency and finishing | Becoming a high-level builder |
| Python projects | Better fundamentals | AI + systems + security |
| Learning in public | Making ideas production-ready | Building things worth using |
...
Does it work?
    └── No  → Read the error.
                ...
                Search the error.
                Fix the error.
                Accidentally learn something important.
...
⭐ If you find something useful here, explore a repository and say hello.
